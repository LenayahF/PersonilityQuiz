...
class QuestionViewController: UIViewController {
    ...
    @IBOutlet weak var horizontalSlider1: UISlider!
    ...
    func updateSingleStack(using answers: [Answer]) { singleStackView.isHidden = false
    ...
    func updateUI() {
       ...
       @IBAction func singleAnswerButtonPressed(_ sender: UIButton) {
          ...
          func nextQuestion() {
              questionIndex += 1
                  if questionIndex < questions.count { updateUI()
